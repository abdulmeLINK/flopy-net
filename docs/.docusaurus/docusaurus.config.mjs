...
export default {
  ...
  "baseUrl": "/flopy-net/",
  "organizationName": "abdulmelink",
  "projectName": "flopy-net",
  "onBrokenLinks": "warn",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/abdulmelink/flopy-net/tree/main/docs/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Abdulmelik Saylan. FLOPY-NET is open source under the MIT License."
    },
    "prism": {
      "theme": {
        "plain": {
