...
from src.scenarios.common.component_deployer import ComponentDeploymentMixin
...
class BaseScenario(ComponentDeploymentMixin):
    ...
    # Component deployment methods (_deploy_components, _deploy_component, _wait_for_component,
    # _verify_component_status, _get_component_config) are provided via ComponentDeploymentMixin
